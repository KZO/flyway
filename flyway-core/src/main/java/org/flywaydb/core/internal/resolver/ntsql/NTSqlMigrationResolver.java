 ...
 */
package org.flywaydb.core.internal.resolver.ntsql;
...
/**
 * No transactional migration resolver for sql files on the classpath. The sql files must have names like
 * NTV1__Description.sql or NTV1_1__Description.sql.
 */
